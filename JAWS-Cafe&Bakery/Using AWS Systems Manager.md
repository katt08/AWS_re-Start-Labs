...
## **Objectives**
After completing this lab, I was be able to use Systems Manager to do the following:
...
In this task, I used **Fleet Manager** (a capability of AWS Systems Manager) to gather inventory information from a managed EC2 instance. The inventory feature helps collect OS details, installed software, and configuration metadata across managed instances without requiring SSH access. This is useful when validating software compliance and configuration state across servers.
